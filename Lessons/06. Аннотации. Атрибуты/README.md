...
который используется в Java (JavaDoc) и C# (XmlDoc). Этот инструмент называется phpDocumentator и для его установки
удобно воспользоваться composer, пакет называется phpdocumentator/phpdocumentator
